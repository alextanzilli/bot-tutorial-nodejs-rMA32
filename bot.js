...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexRock = /^\/rockthevote/; botRegexStats = /^\/stats/; botRegexEric = /^\/eric/; botRegexBrain = /^\/brain/;
      botRegexSiege = /^\/siege/
  ...
  if(request.text && botRegexmfl.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/spreadsheets/d/1h2vHYSGyoGtdtm0WSavIePm_IGjONvigvCK558BQuak/edit#gid=1788313544");
    this.res.end();
  }
    ...
    this.res.writeHead(200);
    postMessage("http://goo.gl/forms/P5aXuUcgZkknUTlr2");
    this.res.end();
  }
    ...
    this.res.writeHead(200);
    postMessage("http://goo.gl/forms/gJbJ2c1i2qCG2N5d2")
    this.res.end();
    }      
