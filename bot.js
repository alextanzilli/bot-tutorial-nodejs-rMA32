...
function respond() {
  ...
  if(request.text && botRegexmfl.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/spreadsheets/d/1ozYieBbkLrs5ZWwECN_3wJEHPRYll8wrQ6L1cF6Mg6Y/edit#gid=1245942090");
    this.res.end();
  }
    ...
    this.res.writeHead(200);
    postMessage("https://forms.gle/DPGJirpP3U4saKUe6");
    this.res.end();
  }
